...
typedef enum {
  ...
  GRPC_STATS_COUNTER_COMPLETION_QUEUE_EVENT_POP,
  GRPC_STATS_COUNTER_COMPLETION_QUEUE_EVENT_POP_ACQUIRED_LOCK,
...
#define GRPC_STATS_INC_SERVER_SLOWPATH_REQUESTS_QUEUED(exec_ctx) \
  GRPC_STATS_INC_COUNTER((exec_ctx),                             \
                         GRPC_STATS_COUNTER_SERVER_SLOWPATH_REQUESTS_QUEUED)
#define GRPC_STATS_INC_COMPLETION_QUEUE_EVENT_POP(exec_ctx) \
  GRPC_STATS_INC_COUNTER((exec_ctx),                        \
                         GRPC_STATS_COUNTER_COMPLETION_QUEUE_EVENT_POP)
#define GRPC_STATS_INC_COMPLETION_QUEUE_EVENT_POP_ACQUIRED_LOCK(exec_ctx) \
  GRPC_STATS_INC_COUNTER(                                                 \
      (exec_ctx), GRPC_STATS_COUNTER_COMPLETION_QUEUE_EVENT_POP_ACQUIRED_LOCK)
